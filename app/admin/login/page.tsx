  ...
  return (
    <main className="flex min-h-screen items-center justify-center bg-[#f6f7f9] px-5 py-10">
      <div className="flex w-full max-w-md flex-col items-center gap-10">
        ...
        <section className="flex w-full flex-col gap-6 rounded-[2rem] border border-slate-200/80 bg-white p-6 shadow-[0_18px_55px_-35px_rgba(20,32,51,0.45)] sm:p-8">
          <p className="text-xs font-black tracking-[0.22em] text-[#2f6fed]">PRIVATE ADMIN AREA</p>
          <h1 className="text-3xl font-bold tracking-[-0.07em] text-slate-900">관리자 로그인</h1>
          <p className="text-sm leading-6 text-slate-500">등록한 맛집을 관리하려면 관리자 계정으로 로그인해 주세요.</p>
        ...
        <Link className="block w-fit text-xs font-semibold text-slate-400 transition hover:text-slate-700" href="/">
          ← 공개 페이지로 돌아가기
        </Link>
      </div>
    </main>
